...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { BUTTON_CreateIndirect, TextBack,    ID_BUTTON_1, 150, 261, 80,  25, 0, 0x0, 0 },
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { EDIT_CreateIndirect,   "year",    ID_EDIT_0,   110, 30, 80, 20, EDIT_CF_HCENTER, 0x64, 0 },
  { EDIT_CreateIndirect,   "month",   ID_EDIT_1,   110, 60, 80, 20, EDIT_CF_HCENTER, 0x64, 0 },
  { EDIT_CreateIndirect,   "day",     ID_EDIT_2,   110, 90, 80, 20, EDIT_CF_HCENTER, 0x64, 0 },
  { EDIT_CreateIndirect,   "hour",    ID_EDIT_3,   110, 120, 80, 20, EDIT_CF_HCENTER, 0x64, 0 },
...
u32 Time_From_Widget(unsigned char *time)
{
    ...
    //if(atoi(TimeBuf)>59)
    {
       // GUI_WARN(g_hWin_TimeSet,GUI_MSBOX_MIN_ERROR);
        //WM_SetFocus(hItem);
        //return DEV_ERROR;
    }
   // else
    ...
    //if(atoi(TimeBuf)>23)
    {
        //GUI_WARN(g_hWin_TimeSet,GUI_MSBOX_HOUR_ERROR);
        //WM_SetFocus(hItem);
        //return DEV_ERROR;
    }
    //else
    ...
    //if(atoi(TimeBuf)>31)
    {
        //GUI_WARN(g_hWin_TimeSet,GUI_MSBOX_DAY_ERROR);
        //WM_SetFocus(hItem);
       // return DEV_ERROR;
    }
    //else
    ...
    if(atoi(TimeBuf)>12)
    {
        //GUI_WARN(g_hWin_TimeSet,GUI_MSBOX_MONTH_ERROR);
        //WM_SetFocus(hItem);
       // return DEV_ERROR;
    }
    else
                ...
                case GUI_KEY_ENTER:
                    switch(Id)
                    {
                        case ID_EDIT_0:
                            ...
                            g_hWin_Edit=Create_Edit_Inpt(g_hWin_TimeSet);                   
                        ...
                        case ID_EDIT_6:
                            ...
                            g_hWin_Edit = Create_Edit_Sel(g_hWin_TimeSet);
                            break;
                   }
                    break;
            }
