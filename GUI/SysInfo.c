...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { TEXT_CreateIndirect,     HardVersion,  ID_TEXT_3,    12,  107,  80,  20, 0, 0x0,  0 },
  { TEXT_CreateIndirect,     SoftVersion,  ID_TEXT_4,    12,  138,  80,  20, 0, 0x0,  0 },
  { TEXT_CreateIndirect,     Voltage,      ID_TEXT_5,    12,  169,  80,  20, 0, 0x0,  0 },
    
  { EDIT_CreateIndirect,     "Edit",       ID_EDIT_0,    140, 12,  95,  20, EDIT_CF_HCENTER, 0x64, 0 },
  { EDIT_CreateIndirect,     "Edit",       ID_EDIT_1,    140, 43,  95,  20, EDIT_CF_HCENTER, 0x64, 0 },
  { EDIT_CreateIndirect,     "*",          ID_EDIT_2,    140, 109, 95,  20, EDIT_CF_HCENTER, 0x64,  0 },
  { EDIT_CreateIndirect,     "*",          ID_EDIT_3,    140, 138, 95,  20, EDIT_CF_HCENTER, 0x64,  0 },
  { EDIT_CreateIndirect,     "*",          ID_EDIT_4,    140, 169, 95,  20, 0, 0x64,  0 },
